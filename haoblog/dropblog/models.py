...
class Category(models.Model):
    ...
    def get_absolute_url(self):
        ...
        return ('category', (), {'category_name': self.name})
...
class Entry(models.Model):
    ...
    def get_absolute_url(self):
        ...
        du = DropboxUser.objects.get(uid=self.author.username)
        author = DropboxUser.objects.get(url_name__iexact=du.url_name)
        return ('entry_detail', (), {'entry_title': self.url_title, 'url_name': author.url_name})
